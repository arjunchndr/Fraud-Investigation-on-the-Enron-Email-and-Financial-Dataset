...
""" A basic script for importing POI identifier,
    and verifying its results. 

    Specifies the algorithm, dataset, and features list to
    be written to classifier.pkl, dataset.pkl, and
    feature_list.pkl, respectively  
"""
